...
BEGIN
	...
	BEGIN TRY
		...
		PRINT '---------------------------------------------------------------------------------------';
		PRINT 'Truncating silver.crm_customer_info';
		...
		PRINT 'Loading silver.crm_product_info';
		...
		PRINT '---------------------------------------------------------------------------------------';
		PRINT 'Truncating silver.erp_customer_info';
		...
		PRINT '---------------------------------------------------------------------------------------';
		PRINT 'Truncating silver.erp_product_categories';

		--Truncating silver.erp_product_categories
		TRUNCATE TABLE silver.erp_product_categories;

		PRINT 'Loading silver.erp_product_categories';
	...
	BEGIN CATCH
		PRINT '---------------------------------------------------------------------------------------';
		PRINT 'Error occoured while loading silver layer:';
